...
class Buch:
    ...
    def __str__(self) -> str:
        """Gibt benutzerfreundliche Darstellung eines Buches zurück."""
    ...
    def __call__(self) -> str:
        """Macht die Instanz aufrugbar und gibt eine Statusmeldung zurück."""
...
# __call__ mach die Instanz aufrufbar wie eine Funktion
